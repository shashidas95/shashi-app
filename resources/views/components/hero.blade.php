            ...
            <div class="col-xxl-5">
                ...
                <div class="text-center text-xxl-start">
                    <div class="badge bg-gradient-primary-to-secondary text-white mb-4">
                        <div id="keyLine" class="text-uppercase">Design &middot; Development &middot; Marketing</div>
                    </div>
                    <div id="title" class="fs-3 fw-light text-muted">I can help your business to</div>
                    <h1 id="short_title" class="display-3 fw-bolder mb-5 text-gradient d-inline">Get online and grow
                        fast</h1>
